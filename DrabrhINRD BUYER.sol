 ...
 */
contract Ownable is Rupee, SafeMath{
...
contract ERC20 is MintableToken {
    constructor() public{
        decimals = 18;     // Amount of decimals for display purposes
        totalSupply = safeMul(99999999, 10**18);     // Update total supply
        balances[msg.sender] = totalSupply;    // Give the creator all initial tokens
        name = "Rupee";    // Set the name for display purposes
        symbol = "INRD";    // Set the symbol for display purposes
    }
}
